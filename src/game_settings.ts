export default {
  ...
  INIITAL_DISTANCE_LOWER: 500, // lower bound initial distance to put between two players, in meters
  INITIAL_DISTANCE_UPPER: 1200, // upper bound initial distance to put between two players, in meters
};
